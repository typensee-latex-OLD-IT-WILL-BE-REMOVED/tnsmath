...
\begin{table}[h]
    ...
    \begin{center}
        \begin{tabular}{c|c|c|c|c|c|c|c|c|c|c|c}
            ...
            \hline \verb+\l+ & $\times$ & $\times$ & $\times$ & $\times$ &          &          & $\times$ &          &          & $\times$ & $\times$ \\
            \hline \verb+\g+ & $\times$ & $\times$ & $\times$ & $\times$ &          &          & $\times$ &          &          & $\times$ & $\times$ \\
            \hline \verb+\leq+ & $\times$ & $\times$ & $\times$ & $\times$ &          &          & $\times$ &          &          & $\times$ & $\times$ \\
            \hline \verb+\geq+ & $\times$ & $\times$ & $\times$ & $\times$ &          &          & $\times$ &          &          & $\times$ & $\times$ \\

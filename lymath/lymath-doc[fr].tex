...
Les formes \og négatives \fg{} des macros auront un nom préfixé par la lettre \prefix{n} en référence à \whyprefix{n}{ot}. C'est l'usage dans le mode \LaTeX{} comme par exemple pour \macro{neq}. 
...
\begin{latexex}
$\dotprod[r] {\dfrac{1}{2} \vect{i}}%
             {\vect{j}}$

$\dotprod[sr]{\dfrac{1}{2} \vect{i}}%
             {\vect{j}}$
\end{latexex}

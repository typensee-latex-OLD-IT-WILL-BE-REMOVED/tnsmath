...
% --------------- %
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item \verb+\probacond+ et \verb+\probacond*+ servent à écrire des probabilités conditionnelles.

            \item \verb+\probatree+ simplifie la production d'arbres probabilistes pondérés et aussi d'arbres de décision.
        \end{itemize}

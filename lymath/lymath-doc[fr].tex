...
Les versions étoilées proposent des mises en forme correspondant aux cas les moins usuels ou les moins pratiques : par exemple, la macro \macro{integrate} rédige $x = a$ et $x = b$ pour les bornes tandis que la version étoilée affichera juste $a$ et $b$.
